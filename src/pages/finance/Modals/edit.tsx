...
interface propsModal {
  setModal(vl: propsField_I | null): void;
  initialVl: propsField_I;
...
export const ModalEdit = (props: propsModal): JSX.Element => {
  const [fields, setFields] = useState<propsField_I>(
    props.initialVl as propsField_I
  );
        ...
        <div className="px-5 grid grid-cols-[1fr_200px] gap-2">
          <label className="flex flex-1 gap-y-1 flex-col">
            ...
            <Select
              ...
              value={options.find((e) => e.value === fields.type_transation)}
              options={options}
